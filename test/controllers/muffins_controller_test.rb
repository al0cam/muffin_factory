...
class MuffinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create muffin" do
    assert_difference("Muffin.count") do
      post muffins_url, params: { muffin: { description: @muffin.description, name: @muffin.name, price: @muffin.price } }
    end
  ...
  test "should update muffin" do
    patch muffin_url(@muffin), params: { muffin: { description: @muffin.description, name: @muffin.name, price: @muffin.price } }
